    ...
    public function buttonClasses(): string
    {
        ...
        $variants = [
            'default' => [
                ...
                'danger' => 'bg-danger text-danger-foreground hover:bg-danger/78',
            ...
            'outline' => [
                ...
                'danger' => 'border border-danger text-danger bg-transparent hover:bg-muted',
            ...
            'link' => [
                ...
                'danger' => 'bg-transparent text-danger underline-offset-4 hover:underline px-0 py-0 h-auto',
        ...
        return trim("$base {$variants[$this->variant][$this->intent]} {$sizes[$this->size]} {$this->class}");
    }
