<x-admin.root>
    ...
    <form action="{{ route('admin.sellers.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <x-ui.card.card-content class="grid grid-cols-3 gap-6">
                ...
                <x-ui.card>
                    ...
                    <x-ui.card.card-content class="space-y-4">
                        <x-ui.field.field-set>
                            <x-ui.field.field-legend>Store Type</x-ui.field.field-legend>
                            <x-ui.field.field-description>Select the type of store for the
                                seller.</x-ui.field.field-description>
                            <x-ui.radio-group.radio-group>
                                <x-ui.field orientation="horizontal">
                                    <x-ui.radio-group.radio-group-item id="store" name="store_type"
                                        value="store" />
                                    <x-ui.field.field-label for="store">Store</x-ui.field.field-label>
                                </x-ui.field>
                                <x-ui.field orientation="horizontal">
                                    <x-ui.radio-group.radio-group-item id="individual" name="store_type"
                                        value="individual" />
                                    <x-ui.field.field-label for="individual">Individual</x-ui.field.field-label>
                                </x-ui.field>
                            </x-ui.radio-group.radio-group>
                            <x-ui.field.field-error :messages="$errors->get('store_type')" />
                        </x-ui.field.field-set>
                ...
                <x-ui.card>
                    <x-ui.card.card-header>
                        ...
                        <x-ui.card.card-description>
                            Login credentials for the seller.
                        </x-ui.card.card-description>
                    </x-ui.card.card-header>
                    <x-ui.card.card-content class="space-y-4">
                        <x-ui.field.field>
                ...
                <x-ui.card>
                    <x-ui.card.card-header>
                        ...
                        <x-ui.card.card-description>
                            Additional profile information for the seller.
                        </x-ui.card.card-description>
                    </x-ui.card.card-header>
                    <x-ui.card.card-content class="space-y-4">
                        <x-ui.field.field>
                            <x-ui.field.field-label for="first_name">First Name</x-ui.field.field-label>
                            <x-ui.input id="first_name" name="first_name" type="text" :value="old('first_name')" />
                        ...
                        <x-ui.field.field>
                            ...
                            <x-ui.input id="last_name" name="last_name" type="text" :value="old('last_name')" />
                            <x-ui.field.field-error :messages="$errors->get('last_name')" />
                        </x-ui.field.field>
                        <x-ui.field.field>
                            <x-ui.field.field-label for="phone">Phone Number</x-ui.field.field-label>
                            <x-ui.input id="phone" name="phone" type="tel" :value="old('phone')" />
                            <x-ui.field.field-error :messages="$errors->get('phone')" />
                        </x-ui.field.field>
                        <x-ui.field.field>
